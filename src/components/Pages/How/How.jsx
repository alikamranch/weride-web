            ...
            <div>
                ...
                <div>
                    <MDBContainer fluid className="how-container-bg">
                        <br />
                        <br />
                        <h3><b><strong>Follow These Simple Steps </strong></b></h3>
                        <br />
                        <br />
                        <br />
                        <MDBRow className="justify-content-center">
                            <MDBCol lg="3" md="5" sm="4" size="8" className="offset-lg-2 offset-sm-0">
                                <br />

                                <img id="stepper1" className="img-fluid how-stepper-fade fade" src={stepperPlaceholder} alt="" />

                                <img id="stepper2" className="img-fluid how-stepper-display how-stepper-fade fade" src={stepperPlaceholder2} alt="" />

                                <img id="stepper3" className="img-fluid how-stepper-display how-stepper-fade fade" src={stepperPlaceholder3} alt="" />

                                <img id="stepper4" className="img-fluid how-stepper-display how-stepper-fade fade" src={stepperPlaceholder4} alt="" />
                            ...
                            <MDBCol lg="5" md="7" sm="8">
                                <div className={"how-step-card " + (this.state.active1 ? 'active' : null)} onClick={this.toggleClass(1)} >
                                    <div className="how-step-counter">
                                        <span>1</span>
                                    </div>
                                    <div className="how-step-body">
                                        <h5 class="how-step-title"><b>Set your pickup location</b></h5>
                                        <p class="how-step-description">Search for a location or drop a pin on the map.</p>
                                    </div>
                                </div>


                                <div className={"how-step-card " + (this.state.active2 ? 'active' : null)} onClick={this.toggleClass(2)} >
                                    <div className="how-step-counter">
                                        <span>2</span>
                                    </div>
                                    <div className="how-step-body">
                                        <h5 class="how-step-title"><b>Choose your vehicle type</b></h5>
                                        <p class="how-step-description">Choose how you want to get there.</p>
                                    </div>
                                </div>


                                <div className={"how-step-card " + (this.state.active3 ? 'active' : null)} onClick={this.toggleClass(3)} >
                                    <div className="how-step-counter">
                                        <span>3</span>
                                    </div>
                                    <div className="how-step-body">
                                        <h5 class="how-step-title"><b>Share your ride with other passengers</b></h5>
                                        <p class="how-step-description">Pool your ride with other people with the same destination.</p>
                                    </div>
                                </div>


                                <div className={"how-step-card " + (this.state.active4 ? 'active' : null)} onClick={this.toggleClass(4)} >
                                    <div className="how-step-counter">
                                        <span>4</span>
                                    </div>
                                    <div className="how-step-body">
                                        <h5 class="how-step-title"><b>Pay after the trip is completed.</b></h5>
                                        <p class="how-step-description">Save on the fare and pay for your shared ride either with cash or the app wallet.</p>
                                    </div>
                                </div>
                            </MDBCol>
                        </MDBRow>
                ...
                <div>
                    <MDBContainer fluid>
                        ...
                        <h3><b><strong>Meet Our Fleet </strong></b></h3>
                        <MDBContainer>
                            <MDBNav className="nav-tabs mt-5 nav-justified">
                                <MDBNavItem>
                                    <MDBNavLink link to="#" active={this.state.activeItem === "1"} onClick={this.toggle("1")} role="tab" >
                                        <img className="img-fluid how-fleet-car" src={standard} alt=""></img>
                                        <br />
                                        Standard
            </MDBNavLink>
                                </MDBNavItem>
                                <MDBNavItem>
                                    <MDBNavLink link to="#" active={this.state.activeItem === "2"} onClick={this.toggle("2")} role="tab" >
                                        <img className="img-fluid how-fleet-rickshaw" src={rickshaw} alt="" />
                                        <br />
                                        Rickshaw
            </MDBNavLink>
                                </MDBNavItem>
                            ...
                            <MDBTabContent activeItem={this.state.activeItem} >
                                <MDBTabPane tabId="1" role="tabpanel" className="how-container-bg">
                                    <MDBRow>
                                        <MDBCol md="5" >
                                            <img className="img-fluid mt-5 mb-5" src={standard} alt="" />

                                        </MDBCol>
                                        <MDBCol md="7" className="text-left">
                                            <div className="how-fleet-text-margin">
                                                <h3 className=""><b>Standard</b></h3>
                                                <p>Select a standard car with four seats for hassle free commutes to your destination with minimum fares.</p>
                                            </div>

                                        </MDBCol>
                                    </MDBRow>
                                </MDBTabPane>
                                <MDBTabPane tabId="2" role="tabpanel" className="how-container-bg ">
                                    <MDBRow>
                                        <MDBCol md="5" >
                                            <img className="img-fluid mt-5 mb-5 how-fleet-rickshaw2" src={rickshaw} alt="" />

                                        </MDBCol>
                                        <MDBCol md="7" className="text-left">
                                            <div className="how-fleet-text-margin">
                                                <h3 className=""><b>Rickshaw</b></h3>
                                                <p>Select a rickshaw with four to five seats for hassle free commutes to your destination with even less fares.</p>
                                            </div>
