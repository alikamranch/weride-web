...
function Home() {
  ...
  return (
    <div>
      ...
      {/* Carpool Section */}
      <MDBContainer>
        <MDBRow className="justify-content-center top">
          <h1 className="font-style">Why Carpool?</h1>
        </MDBRow>
        <br />
        <br />
        <br />
        <MDBRow className="justify-content-center">
          <MDBCol lg="3">
            ...
            <p className="home-carpool-paragragh">
              With shared rides the fare gets divided among the number of
              riders.
            </p>
          </MDBCol>
          <br />
          ...
          <MDBCol lg="3">
            ...
            <p className="home-carpool-paragragh">
              With more people carpooling there will be less cars on the road.
            </p>
          </MDBCol>
          <br />
          <br />
      ...
      <br />
      {/* Featurette */}
      <div className="home-featurette-background img-fluid"></div>
      <MDBContainer>
        <div className="home-featurette-container-inner text-left">
          <MDBRow>
            <MDBCol lg="6">
              <h1 className="home-featurette-heading">Why ride with us?</h1>
              <p className="home-featurette-paragragh ">
                WERide is the first dedicated carpooling service in Pakistan.
                Our aim is to provide cheap journeys with the utmost security
            ...
            <MDBCol lg="6" className="img-fluid">
              <img
                src={carpool}
                alt="carpool-concept"
                className="mx-auto home-featurette-carpoolimg img-fluid"
              />
            </MDBCol>
          </MDBRow>
        </div>
      ...
      <MDBContainer fluid style={{ padding: "50px" }}>
        <MDBRow>
          ...
          <MDBCol lg="6" className="text-left">
            ...
            <br />
            <br />
            <h1 className="home-featurette-heading">
              Keep making friends on the go.
            </h1>
            <p className="home-featurette-paragragh ">
              Our main purpose is to bring the Pakistani community together. We
              encourage interaction during the journey. What's better than
              paying less and spending some quality time right?
            </p>
          </MDBCol>
        </MDBRow>
      </MDBContainer>
      ...
      <MDBContainer fluid style={{ padding: "50px" }}>
        <MDBRow>
          <MDBCol lg="6" className="text-left">
            ...
            <br />
            <h1 className="home-featurette-heading">
              Travel on the same route and save both money and time.
            </h1>
            <p className="home-featurette-paragragh ">
              WERide works by connecting the rides of people who have the same
              destination and route. The fare is divided among the number of
              riders and you save time by riding together.
            </p>
          </MDBCol>
        ...
        <MDBContainer fluid style={{ padding: "50px" }}>
          <MDBRow>
            ...
            <MDBCol lg="6" className="text-left">
              ...
              <p className="home-featurette-paragragh ">
                The rising expense of car booking applications has led to people
                seeking shared rides. The high demand will result in a steady
                income.
              </p>
            </MDBCol>
          </MDBRow>
        ...
        <MDBContainer fluid style={{ padding: "50px" }}>
          <MDBRow>
            <MDBCol lg="6" className="text-left">
              ...
              <p className="home-featurette-paragragh ">
                It is WERide's utmost priority to bring you the best customers
                for a pleasant and hassle-free trip.
              </p>
            </MDBCol>
        ...
        <MDBContainer fluid style={{ padding: "50px" }}>
          <MDBRow>
            ...
            <MDBCol lg="6" className="text-left">
              ...
              <p className="home-featurette-paragragh ">
                Drivers will have the comfort of working whenever and wherever
                they want and at a time of their convenience.
              </p>
            </MDBCol>
          </MDBRow>
        </MDBContainer>
